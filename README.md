...
- **restaurants_data.xlsx** – Contains restaurant details with 19 attributes
...
- Find ratio of restaurants allowing table booking vs not  
- Calculate percentage of restaurants providing online delivery  
...
- Find maximum and minimum cuisines per restaurant  
